...
public class TransactionHistoryDialog extends JDialog {
    ...
    private JLabel lblTotalTransactions, lblTotalAmount;
    ...
    private JPanel createSummaryCard(String title, String value, Color color) {
        ...
        if (title.equals("Total Transaksi")) {
            ...
            lblTotalAmount = new JLabel(value);
            lblValue = lblTotalAmount;
        }
    ...
    private void loadData() {
        ...
        try (Connection conn = DatabaseConfig.getConnection()) {
            ...
            lblTotalAmount.setText(FormatterUtils.formatCurrency(totalAmount));
    ...
    private void printReceipt() {
        ...
        try (Connection conn = DatabaseConfig.getConnection()) {
            ...
            if (rs1.next()) {
                ...
                receipt.append("         www.distrozone.com         \n");
                receipt.append("═".repeat(50)).append("\n");
